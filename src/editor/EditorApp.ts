...
const ENTITY_DEFAULTS: Record<string, Record<string, unknown>> = {
  ...
  trap_launcher:  { facing: 'S', projectileType: 'dart', fireMode: 'repeat', reloadTime: 3, maxRange: 20 },
  torch_sconce:   { wall: 'N' },
  enemy:          { enemyType: 'rat' },
  equipment:      { itemId: '' },
  consumable:     { itemId: '' },
  ...
  boulder:        { direction: 'N', state: 'idle', rollDamage: 30, fallDamage: 60, instaKillEnemies: true, pushable: false },
  prop:           { propId: 'pillar' },
...
export class EditorApp {
  ...
  selectedBoulderConfig = {
    ...
    state: 'idle' as 'idle' | 'rolling' | 'falling',
    rollDamage: 30,
    fallDamage: 60,
